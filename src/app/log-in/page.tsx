          ...
          <div className="mb-6">
            <div className="relative">
              <input
                ...
                className="w-full bg-gray-100 border border-gray-200 rounded-card-lg py-4 px-4 pr-12 text-text-primary placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-all"
                aria-label="Password"
              />
              <button
                type="button"
